...
#ifndef __GCC4_has_attribute_fallthrough
#define __GCC4_has_attribute_fallthrough 0
#endif
...
static inline void gen_random_bytes(void *buf, int bytes)
{
	int i;
...
#define ethtool_eee ethtool_keee
#endif
