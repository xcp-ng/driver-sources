...
/* used to extract the correct ELS cmd code from the above defines */
#define lpfc_extract_cmd_byte(x) (u8)(le32_to_cpu(x) & 0xff)
...
#define  RPRT_VENDOR_CGN              0xf047 /* vendor ascii string */
...
#define PCI_DEVICE_ID_LANCER_G7S_FC 0xf600
...
enum init_link_word2 {
	FLAGS_TOPOLOGY_MODE_LOOP_PT	= 0x0000, /* Attempt loop then pt-pt */
	FLAGS_LOCAL_LB			= 0x0001, /* link_flags (=1) ENDEC loopback */
	FLAGS_TOPOLOGY_MODE_PT_PT	= 0x0002, /* Attempt pt-pt only */
	FLAGS_TOPOLOGY_MODE_LOOP	= 0x0004, /* Attempt loop only */
	FLAGS_TOPOLOGY_MODE_PT_LOOP	= 0x0006, /* Attempt pt-pt then loop */
	FLAGS_UNREG_LOGIN_ALL		= 0x0008, /* UNREG_LOGIN all on link down */
	FLAGS_LIRP_LILP			= 0x0080, /* LIRP / LILP is disabled */

	FLAGS_TOPOLOGY_FAILOVER		= 0x0400, /* Bit 10 */
	FLAGS_LINK_SPEED		= 0x0800, /* Bit 11 */
	FLAGS_IMED_ABORT		= 0x4000, /* Bit 14 */
};

enum init_link_word3 {
	LINK_SPEED_AUTO		= 0x0,	/* Auto selection */
	LINK_SPEED_1G		= 0x1,	/* 1 Gigabaud */
	LINK_SPEED_2G		= 0x2,	/* 2 Gigabaud */
	LINK_SPEED_4G		= 0x4,	/* 4 Gigabaud */
	LINK_SPEED_8G		= 0x8,	/* 8 Gigabaud */
	LINK_SPEED_10G		= 0x10,	/* 10 Gigabaud */
	LINK_SPEED_16G		= 0x11,	/* 16 Gigabaud */
	LINK_SPEED_32G		= 0x14,	/* 32 Gigabaud */
	LINK_SPEED_64G		= 0x17,	/* 64 Gigabaud */
	LINK_SPEED_128G		= 0x1A,	/* 128 Gigabaud */
	LINK_SPEED_256G		= 0x1D,	/* 256 Gigabaud */
};
...
enum config_link_word1 {
	CONFIG_LINK_CR			= (0x1 << 7),
	CONFIG_LINK_CI			= (0x1 << 6),
	CONFIG_LINK_CR_DELAY_SHIFT	= 0,
	CONFIG_LINK_CR_DELAY_MASK	= (0x3f << CONFIG_LINK_CR_DELAY_SHIFT),
};

enum config_link_word10 {
	CONFIG_LINK_CSCN	= (0x1 << 12),
	CONFIG_LINK_BBSCN_SHIFT	= 8,
	CONFIG_LINK_BBSCN_MASK	= (0xf << CONFIG_LINK_BBSCN_SHIFT),
};

enum config_link_word11 {
	CONFIG_LINK_ACK0_ENABLE	= (0x1 << 0),
};

struct config_link_s3 {
	u8 max_bbc;
	u8 rsvd5;
	u8 cr_count;
	u8 cr_ci_cr_delay; /* cr 7, ci 6, cr_delay 5:0 */
	...
	__le32 word10; /* cscn 12, bbscn 11:8, rsvd 7:0 */

	/* rrq_enable 31, rrq_immed 30, alpa_fc: 29, eer 28, cts 27, rrqs 26,
	 * rsvd 25:24, eer_level 23:16, rsvd 15:1, ack0_en 0
	 */
	__le32 word11;
...
struct config_link_s4 {
	...
	__le32 word10; /* rsvd 31:13, cscn 12, bbscn 11:8, rsvd 7:0 */

	__le32 rsvd44;
};

/* Structure for MB Command CONFIG_RING (09) */
enum config_ring_word1 {
	CONFIG_RING_RN	= 1,
};
...
struct config_ring {
	...
	u8 profile;
	u8 num_mask;
	u8 buddy_rn; /* rsvd 7, buddy 6, rsvd 5:1, rn 0 */

	__le32 rsvd8;

	struct rr_reg rr_regs[6];
};
...
enum read_config_word3 {
	RD_CFG_AR	= 0x80,
	RD_CFG_IR	= 0x40,
};

enum read_config_word9 {
	LMT_1GB		= 0x004,
	LMT_2GB		= 0x008,
	LMT_4GB		= 0x040,
	LMT_8GB		= 0x080,
...
struct read_config {
	...
	u8 ack0; /* rsvd 7:1, ack0 0 */
	__le16 rsvd13;
	u8 ar_ir; /* ar 7, ir 6, rsvd 5:0 */
...
struct read_sparm {
	...
	/* This BDE points to struct serv_parm structure */
	struct ulp_bde64_le sp64;
...
typedef union {
	...
	struct init_link init_link;		/* cmd = 5 (INIT_LINK) */
	struct config_link_s3 cfg_lnk_s3;	/* cmd = 7 (CONFIG_LINK) */
	struct config_link_s4 cfg_lnk;
	struct config_ring cfg_ring;		/* cmd =  9 (CONFIG_RING) */
	RESET_RING_VAR varRstRing;	/* cmd = 10 (RESET_RING)     */
	struct read_config rd_cfg;		/* cmd = 11 (READ_CONFIG) */
	struct read_sparm rd_sparm;		/* cmd = 0x8D (READ_SPARM64) */
