...
const struct bnxt_ulp_generic_tbl_params ulp_wh_plus_generic_tbl_params[] = {
	...
	[BNXT_ULP_RESOURCE_SUB_TYPE_GENERIC_TABLE_L2_FILTER << 1 |
		BNXT_ULP_DIRECTION_INGRESS] = {
	.name = "INGRESS GENERIC_TABLE_L2_FILTER",
	.gen_tbl_type = BNXT_ULP_GEN_TBL_TYPE_KEY_LIST,
	.result_num_entries = 0,
	.result_num_bytes = 0,
	.key_num_bytes = 0,
	...
	[BNXT_ULP_RESOURCE_SUB_TYPE_GENERIC_TABLE_L2_FILTER << 1 |
		BNXT_ULP_DIRECTION_EGRESS] = {
	.name = "EGRESS GENERIC_TABLE_L2_FILTER",
	.gen_tbl_type = BNXT_ULP_GEN_TBL_TYPE_KEY_LIST,
	.result_num_entries = 0,
	.result_num_bytes = 0,
	.key_num_bytes = 0,
	...
	[BNXT_ULP_RESOURCE_SUB_TYPE_GENERIC_TABLE_IFA_TUNNEL_CACHE << 1 |
		BNXT_ULP_DIRECTION_INGRESS] = {
	.name = "INGRESS GENERIC_TABLE_IFA_TUNNEL_CACHE",
	.gen_tbl_type = BNXT_ULP_GEN_TBL_TYPE_KEY_LIST,
	.result_num_entries = 0,
	.result_num_bytes = 0,
	.key_num_bytes = 0,
	...
	[BNXT_ULP_RESOURCE_SUB_TYPE_GENERIC_TABLE_IFA_TUNNEL_CACHE << 1 |
		BNXT_ULP_DIRECTION_EGRESS] = {
	.name = "EGRESS GENERIC_TABLE_IFA_TUNNEL_CACHE",
	.gen_tbl_type = BNXT_ULP_GEN_TBL_TYPE_KEY_LIST,
	.result_num_entries = 0,
	.result_num_bytes = 0,
	.key_num_bytes = 0,
	...
	[BNXT_ULP_RESOURCE_SUB_TYPE_GENERIC_TABLE_L2_CNTXT_ID_CACHE << 1 |
		BNXT_ULP_DIRECTION_INGRESS] = {
	.name = "INGRESS GENERIC_TABLE_L2_CNTXT_ID_CACHE",
	.gen_tbl_type = BNXT_ULP_GEN_TBL_TYPE_KEY_LIST,
	.result_num_entries = 0,
	.result_num_bytes = 0,
	.key_num_bytes = 0,
	...
	[BNXT_ULP_RESOURCE_SUB_TYPE_GENERIC_TABLE_L2_CNTXT_ID_CACHE << 1 |
		BNXT_ULP_DIRECTION_EGRESS] = {
	.name = "EGRESS GENERIC_TABLE_L2_CNTXT_ID_CACHE",
	.gen_tbl_type = BNXT_ULP_GEN_TBL_TYPE_KEY_LIST,
	.result_num_entries = 0,
	.result_num_bytes = 0,
	.key_num_bytes = 0,
...
struct bnxt_ulp_app_capabilities_info ulp_app_cap_info_list[] = {
	...
	.feature_bits            = BNXT_ULP_FEATURE_BIT_PORT_DMAC |
			BNXT_ULP_FEATURE_BIT_PARENT_DMAC |
			BNXT_ULP_FEATURE_BIT_MULTI_TUNNEL_FLOW,
	.default_feature_bits    = BNXT_ULP_FEATURE_BIT_PORT_DMAC,
	.default_class_bits      = 0,
	.default_act_bits        = BNXT_ULP_ACT_BIT_GENERIC
	}
};
...
uint32_t ulp_act_prop_map_table[] = {
	...
	[BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_LABEL] =
		BNXT_ULP_ACT_PROP_SZ_OF_PUSH_MPLS0_LABEL,
	[BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_TC] =
		BNXT_ULP_ACT_PROP_SZ_OF_PUSH_MPLS0_TC,
	[BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_BOS] =
		BNXT_ULP_ACT_PROP_SZ_OF_PUSH_MPLS0_BOS,
	[BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_TTL] =
		BNXT_ULP_ACT_PROP_SZ_OF_PUSH_MPLS0_TTL,
	[BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_LABEL] =
		BNXT_ULP_ACT_PROP_SZ_OF_PUSH_MPLS1_LABEL,
	[BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_TC] =
		BNXT_ULP_ACT_PROP_SZ_OF_PUSH_MPLS1_TC,
	[BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_BOS] =
		BNXT_ULP_ACT_PROP_SZ_OF_PUSH_MPLS1_BOS,
	[BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_TTL] =
		BNXT_ULP_ACT_PROP_SZ_OF_PUSH_MPLS1_TTL,
	...
	[BNXT_ULP_ACT_PROP_IDX_GOTO_CHAIN] =
		BNXT_ULP_ACT_PROP_SZ_GOTO_CHAIN,
	...
	[BNXT_ULP_ACT_PROP_IDX_UPDATE_KID] =
		BNXT_ULP_ACT_PROP_SZ_UPDATE_KID,
	[BNXT_ULP_ACT_PROP_IDX_RING_TBL_IDX] =
		BNXT_ULP_ACT_PROP_SZ_RING_TBL_IDX,
	[BNXT_ULP_ACT_PROP_IDX_POP_MPLS_DEPTH] =
		BNXT_ULP_ACT_PROP_SZ_POP_MPLS_DEPTH,
