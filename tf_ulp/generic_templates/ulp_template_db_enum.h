...
#define BNXT_ULP_GLB_FIELD_TBL_SIZE 137
...
#define ULP_THOR_CLASS_TBL_LIST_SIZE 177
#define ULP_THOR_CLASS_KEY_INFO_LIST_SIZE 809
#define ULP_THOR_CLASS_KEY_EXT_LIST_SIZE 666
#define ULP_THOR_CLASS_IDENT_LIST_SIZE 54
#define ULP_THOR_CLASS_RESULT_FIELD_LIST_SIZE 1298
#define ULP_THOR_CLASS_COND_LIST_SIZE 4014
#define ULP_THOR_CLASS_COND_OPER_LIST_SIZE 15
#define ULP_THOR2_CLASS_TMPL_LIST_SIZE 5
#define ULP_THOR2_CLASS_TBL_LIST_SIZE 180
#define ULP_THOR2_CLASS_KEY_INFO_LIST_SIZE 807
#define ULP_THOR2_CLASS_KEY_EXT_LIST_SIZE 664
#define ULP_THOR2_CLASS_IDENT_LIST_SIZE 61
#define ULP_THOR2_CLASS_RESULT_FIELD_LIST_SIZE 1613
#define ULP_THOR2_CLASS_COND_LIST_SIZE 4205
...
#define ULP_THOR_ACT_RESULT_FIELD_LIST_SIZE 492
#define ULP_THOR_ACT_COND_LIST_SIZE 92
#define ULP_THOR_ACT_COND_OPER_LIST_SIZE 0
#define ULP_THOR2_ACT_TMPL_LIST_SIZE 13
#define ULP_THOR2_ACT_TBL_LIST_SIZE 127
#define ULP_THOR2_ACT_KEY_INFO_LIST_SIZE 87
#define ULP_THOR2_ACT_KEY_EXT_LIST_SIZE 5
#define ULP_THOR2_ACT_IDENT_LIST_SIZE 41
#define ULP_THOR2_ACT_RESULT_FIELD_LIST_SIZE 492
#define ULP_THOR2_ACT_COND_LIST_SIZE 100
...
enum bnxt_ulp_cf_idx {
	...
	BNXT_ULP_CF_IDX_LOOKUP_STRENGTH = 123,
	BNXT_ULP_CF_IDX_LOOPBACK_VPORT = 124,
	BNXT_ULP_CF_IDX_LAST = 125
};
...
enum bnxt_ulp_rf_idx {
	...
	BNXT_ULP_RF_IDX_PROF_FUNC_ID_0 = 5,
	BNXT_ULP_RF_IDX_PROF_FUNC_ID_1 = 6,
	BNXT_ULP_RF_IDX_EM_PROFILE_ID_0 = 7,
	BNXT_ULP_RF_IDX_EM_PROFILE_ID_1 = 8,
	BNXT_ULP_RF_IDX_WC_PROFILE_ID_0 = 9,
	BNXT_ULP_RF_IDX_WC_PROFILE_ID_1 = 10,
	BNXT_ULP_RF_IDX_META_ACTION_PTR = 11,
	BNXT_ULP_RF_IDX_MIRR_ACTION_PTR = 12,
	BNXT_ULP_RF_IDX_MAIN_ACTION_PTR = 13,
	BNXT_ULP_RF_IDX_ACTION_PTR_0 = 14,
	BNXT_ULP_RF_IDX_ENCAP_PTR_0 = 15,
	BNXT_ULP_RF_IDX_ENCAP_PTR_1 = 16,
	BNXT_ULP_RF_IDX_MIRR_ENCAP_PTR_0 = 17,
	BNXT_ULP_RF_IDX_CRITICAL_RESOURCE = 18,
	BNXT_ULP_RF_IDX_FLOW_CNTR_PTR_0 = 19,
	BNXT_ULP_RF_IDX_FLOW_CNTR_PTR_1 = 20,
	BNXT_ULP_RF_IDX_MIRR_FLOW_CNTR_PTR_0 = 21,
	BNXT_ULP_RF_IDX_MAIN_SP_PTR = 22,
	BNXT_ULP_RF_IDX_MODIFY_IPV4_SRC_PTR_0 = 23,
	BNXT_ULP_RF_IDX_MODIFY_IPV4_DST_PTR_0 = 24,
	BNXT_ULP_RF_IDX_ACTION_REC_SIZE = 25,
	BNXT_ULP_RF_IDX_L2_CNTXT_TCAM_INDEX_0 = 26,
	BNXT_ULP_RF_IDX_L2_CNTXT_TCAM_INDEX_1 = 27,
	BNXT_ULP_RF_IDX_PROFILE_TCAM_INDEX_0 = 28,
	BNXT_ULP_RF_IDX_PROFILE_TCAM_INDEX_1 = 29,
	BNXT_ULP_RF_IDX_WC_TCAM_INDEX_0 = 30,
	BNXT_ULP_RF_IDX_WC_TCAM_INDEX_1 = 31,
	BNXT_ULP_RF_IDX_SRC_PROPERTY_PTR = 32,
	BNXT_ULP_RF_IDX_GENERIC_TBL_MISS = 33,
	BNXT_ULP_RF_IDX_MIRROR_PTR_0 = 34,
	BNXT_ULP_RF_IDX_MIRROR_ID_0 = 35,
	BNXT_ULP_RF_IDX_HDR_SIG_ID = 36,
	BNXT_ULP_RF_IDX_FLOW_SIG_ID = 37,
	BNXT_ULP_RF_IDX_RID = 38,
	BNXT_ULP_RF_IDX_WC_KEY_ID_0 = 39,
	BNXT_ULP_RF_IDX_EM_KEY_ID_0 = 40,
	BNXT_ULP_RF_IDX_DRV_FUNC_MAC = 41,
	BNXT_ULP_RF_IDX_DRV_FUNC_PARENT_MAC = 42,
	BNXT_ULP_RF_IDX_DEFAULT_AREC_PTR = 43,
	BNXT_ULP_RF_IDX_CC = 44,
	BNXT_ULP_RF_IDX_CF_FLOW_SIG_ID = 45,
	BNXT_ULP_RF_IDX_PHY_PORT = 46,
	BNXT_ULP_RF_IDX_METADATA_PROF = 47,
	BNXT_ULP_RF_IDX_MIRR_MODIFY_PTR = 48,
	BNXT_ULP_RF_IDX_MIR_DROP_ACT_PTR = 49,
	BNXT_ULP_RF_IDX_MODIFY_PTR = 50,
	BNXT_ULP_RF_IDX_INGRESS_MIRROR_TO_PF = 51,
	BNXT_ULP_RF_IDX_INGRESS_LOOPBACK_MIRROR_TO_PF = 52,
	BNXT_ULP_RF_IDX_EGRESS_MIRROR_SEND_TO_LB = 53,
	BNXT_ULP_RF_IDX_DROP_AREC_PTR = 54,
	BNXT_ULP_RF_IDX_SOCK_DIR_SVIF = 55,
	BNXT_ULP_RF_IDX_SOCK_DIR_PARIF = 56,
	BNXT_ULP_RF_IDX_SOCK_DIR_ACT_PTR = 57,
	BNXT_ULP_RF_IDX_SOCK_DIR_PARENT_MAC = 58,
	BNXT_ULP_RF_IDX_RSS_VNIC = 59,
	BNXT_ULP_RF_IDX_PORT_IS_PF = 60,
	BNXT_ULP_RF_IDX_METER_PROFILE_PTR_0 = 61,
	BNXT_ULP_RF_IDX_METER_PTR_0 = 62,
	BNXT_ULP_RF_IDX_REF_CNT = 63,
	BNXT_ULP_RF_IDX_RF_0 = 64,
	BNXT_ULP_RF_IDX_RF_1 = 65,
	BNXT_ULP_RF_IDX_RF_2 = 66,
	BNXT_ULP_RF_IDX_RF_3 = 67,
	BNXT_ULP_RF_IDX_RF_4 = 68,
	BNXT_ULP_RF_IDX_RF_5 = 69,
	BNXT_ULP_RF_IDX_RF_6 = 70,
	BNXT_ULP_RF_IDX_RF_7 = 71,
	BNXT_ULP_RF_IDX_CMM_ACT_HNDL = 72,
	BNXT_ULP_RF_IDX_CMM_ACT_HNDL_MIRROR = 73,
	BNXT_ULP_RF_IDX_CMM_STAT_HNDL = 74,
	BNXT_ULP_RF_IDX_CMM_STAT_HNDL_MIRROR = 75,
	BNXT_ULP_RF_IDX_CMM_MOD_HNDL = 76,
	BNXT_ULP_RF_IDX_CMM_ENC_HNDL = 77,
	BNXT_ULP_RF_IDX_CMM_SRP_HNDL = 78,
	BNXT_ULP_RF_IDX_VF_FUNC_METADATA = 79,
	BNXT_ULP_RF_IDX_CHAIN_ID_METADATA = 80,
	BNXT_ULP_RF_IDX_RECYCLE_CNT = 81,
	BNXT_ULP_RF_IDX_DEST_VNIC = 82,
	BNXT_ULP_RF_IDX_DEST_VPORT = 83,
	BNXT_ULP_RF_IDX_DEST_METADATA = 84,
	BNXT_ULP_RF_IDX_PROF_TCAM_PRI = 85,
	BNXT_ULP_RF_IDX_EM_INSERT_FAIL = 86,
	BNXT_ULP_RF_IDX_PROF_TCAM_PRIORITY = 87,
	BNXT_ULP_RF_IDX_TERM_FLOW = 88,
	BNXT_ULP_RF_IDX_O_DMAC = 89,
	BNXT_ULP_RF_IDX_FLOW_CNTR_PTR_F1 = 90,
	BNXT_ULP_RF_IDX_CMM_STAT_HNDL_F1 = 91,
	BNXT_ULP_RF_IDX_WC_RECIPE_ID = 92,
	BNXT_ULP_RF_IDX_EM_RECIPE_ID = 93,
	BNXT_ULP_RF_IDX_DEFAULT_AREC_PTR_ROCE = 94,
	BNXT_ULP_RF_IDX_JUMP_META_IDX = 95,
	BNXT_ULP_RF_IDX_JUMP_META = 96,
	BNXT_ULP_RF_IDX_TUNNEL_PORT = 97,
	BNXT_ULP_RF_IDX_CF_0 = 98,
	BNXT_ULP_RF_IDX_PM_0 = 99,
	BNXT_ULP_RF_IDX_RFC2698_0 = 100,
	BNXT_ULP_RF_IDX_CBSM_0 = 101,
	BNXT_ULP_RF_IDX_EBSM_0 = 102,
	BNXT_ULP_RF_IDX_CBND_0 = 103,
	BNXT_ULP_RF_IDX_EBND_0 = 104,
	BNXT_ULP_RF_IDX_CBS_0 = 105,
	BNXT_ULP_RF_IDX_EBS_0 = 106,
	BNXT_ULP_RF_IDX_CIR_0 = 107,
	BNXT_ULP_RF_IDX_EIR_0 = 108,
	BNXT_ULP_RF_IDX_OUTER_LOOP = 109,
	BNXT_ULP_RF_IDX_INNER_LOOP = 110,
	BNXT_ULP_RF_IDX_OUTER_ADD = 111,
	BNXT_ULP_RF_IDX_RID_1 = 112,
	BNXT_ULP_RF_IDX_WC_TCAM_PRIORITY = 113,
	BNXT_ULP_RF_IDX_LAST = 114
};
...
enum bnxt_ulp_act_prop_idx {
	...
	BNXT_ULP_ACT_PROP_IDX_GOTO_CHAIN = 396,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_CIR = 400,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_EIR = 403,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_CBS = 406,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_EBS = 408,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_RFC2698 = 410,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_PM = 411,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_EBND = 412,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_CBND = 413,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_EBSM = 414,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_CBSM = 415,
	BNXT_ULP_ACT_PROP_IDX_METER_INST_CF = 416,
	BNXT_ULP_ACT_PROP_IDX_SET_TTL = 417,
	BNXT_ULP_ACT_PROP_IDX_LAST = 418
};
...
enum ulp_thor2_sym {
	...
	ULP_THOR2_SYM_VF_ROCE_MIRROR_PF_META_VAL = 536870912,
