...
default:
	$(MAKE) -C $(BASEINCLUDE) SUBDIRS=$(DRIVERDIR) CONFIG_SCSI_LPFC=m modules
...
brcmfcoe:
	...
	$(MAKE) -C $(BASEINCLUDE) SUBDIRS=$(DRIVERDIR) CONFIG_SCSI_BRCMFCOE=m BUILD_FLAGS=-DBUILD_BRCMFCOE modules
...
clean:
	$(MAKE) -C $(BASEINCLUDE) SUBDIRS=$(DRIVERDIR) CONFIG_SCSI_LPFC=m clean
