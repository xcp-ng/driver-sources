...
#define TX_MAX_FRAGS_ETF	(TX_MAX_BD_CNT - 3)

#define BNXT_TX_MAX_FRAGS(txr)	\
	((txr)->etf_enabled ? TX_MAX_FRAGS_ETF : TX_MAX_FRAGS)
...
#define BNXT_CTX_AFM_KONG_HWRM_TRACE	FUNC_BACKING_STORE_QCAPS_V2_REQ_TYPE_AFM_KONG_HWRM_TRACE
#define BNXT_CTX_ERR_QPC_TRACE		FUNC_BACKING_STORE_QCAPS_V2_REQ_TYPE_ERR_QPC_TRACE
#define BNXT_CTX_MAX	(BNXT_CTX_TIM + 1)
#define BNXT_CTX_L2_MAX (BNXT_CTX_FTQM + 1)
#define BNXT_CTX_INV	((u16)-1)

#define BNXT_CTX_V2_MAX (FUNC_BACKING_STORE_QCAPS_V2_REQ_TYPE_ERR_QPC_TRACE + 1)
...
struct bnxt_bond_info {
	...
	u8 aggr_mode;
	u8 fw_lag_id;
	struct mutex lag_mutex;	/* lock to protect LAG changes */
};

#define BNXT_TRACE_BUF_MAGIC_BYTE ((u8)0xBC)
#define BNXT_TRACE_GROUP_1 (BNXT_CTX_ROCE_HWRM_TRACE - BNXT_CTX_SRT_TRACE + 1)
#define BNXT_TRACE_GROUP_2 (BNXT_CTX_ERR_QPC_TRACE - BNXT_CTX_CA0_TRACE + 1)
...
enum BNXT_SP_EVENTS {
	BNXT_RX_MASK_SP_EVENT = 0,
	BNXT_RX_NTP_FLTR_SP_EVENT,
	BNXT_LINK_CHNG_SP_EVENT,
	BNXT_HWRM_EXEC_FWD_REQ_SP_EVENT,
	BNXT_VXLAN_ADD_PORT_SP_EVENT,
	BNXT_VXLAN_DEL_PORT_SP_EVENT,
	...
	BNXT_VF_VNIC_CHANGE_SP_EVENT,
	BNXT_LINK_CFG_CHANGE_SP_EVENT,
	BNXT_PTP_CURRENT_TIME_EVENT,
	BNXT_FW_ECHO_REQUEST_SP_EVENT,
	BNXT_VF_CFG_CHNG_SP_EVENT,
	BNXT_RESET_TASK_CORE_RESET_SP_EVENT,
	BNXT_THERMAL_THRESHOLD_SP_EVENT,
	BNXT_RESTART_ULP_SP_EVENT,
	BNXT_FW_SET_TIME_SP_EVENT,
	BNXT_PEER_MMAP_EVENT,
	BNXT_ENABLE_SRIOV_DSCP_INSERT_SP_EVENT,
	BNXT_DISABLE_SRIOV_DSCP_INSERT_SP_EVENT,
	BNXT_VF_FLR_SP_EVENT,
	/* Add new flags before this comment */
	BNXT_MAX_SP_EVENTS,
};
...
#define CHIP_NUM_THOR3C		0x1770
#define CHIP_NUM_THOR3CP	0x1778
...
#define BNXT_VPD_FLD_LEN	32
	...
	#define BNXT_FLAG_CHIP_P7_PLUS	0x80000
	...
	#define BNXT_FLAG_HDS		0x10000000
...
#define BNXT_CHIP_P8(bp)			\
	((bp)->chip_num == CHIP_NUM_THOR3C ||	\
	 (bp)->chip_num == CHIP_NUM_THOR3CP)

#define BNXT_CHIP_P7(bp)			\
	((bp)->chip_num == CHIP_NUM_58818 ||	\
	 (bp)->chip_num == CHIP_NUM_57608)

#define BNXT_CHIP_P7_PLUS(bp)			\
	(BNXT_CHIP_P7(bp) || BNXT_CHIP_P8(bp))
...
#define BNXT_CHIP_P5_PLUS(bp)			\
	(BNXT_CHIP_P5(bp) || BNXT_CHIP_P7_PLUS(bp))
...
#define BNXT_CHIP_SUPPORTS_PHY(bp)	(BNXT_ASIC(bp) || BNXT_CHIP_P7_PLUS(bp))
...
#define BNXT_RSS_CAP_LARGE_RSS_CTX		BIT(13)
...
#define BNXT_STATE_TF_MODE_CHANGE	19
...
#define BNXT_NO_FW_ACCESS(bp)					\
	...
	#define BNXT_FW_CAP_ON_CHIP_CTX			BIT_ULL(38)
	...
	#define BNXT_FW_CAP_STEERING_TAG		BIT_ULL(49)
	...
	#define	BNXT_FW_CAP_MIRROR_ON_ROCE		BIT_ULL(5)
	#define	BNXT_MIRROR_ON_ROCE_CAP(bp)	((bp)->fw_cap_ext & \
						 BNXT_FW_CAP_MIRROR_ON_ROCE)
	#define	BNXT_FW_CAP_ROCE_VF_DYN_ALLOC_SUPPORT   BIT_ULL(7)
	#define	BNXT_ROCE_VF_DYN_ALLOC_CAP(bp)	((bp)->fw_cap_ext & \
						 BNXT_FW_CAP_ROCE_VF_DYN_ALLOC_SUPPORT)
	#define BNXT_FW_CAP_PCIE_SECURE_ATS_SUPPORTED  BIT_ULL(8)
	#define BNXT_PCIE_SECURE_ATS_CAP(bp)     ((bp)->fw_cap_ext & \
						  BNXT_FW_CAP_PCIE_SECURE_ATS_SUPPORTED)
	#define	BNXT_FW_CAP_MBUF_DATA			BIT_ULL(9)

	u32			stats_cap;
	#define BNXT_STATS_CAP_PORT		BIT(0)
	#define BNXT_STATS_CAP_ECN		BIT(1)
	#define BNXT_STATS_CAP_ECN_VALID	BIT(2)
	#define BNXT_STATS_CAP_PORT_EXT		BIT(3)
	#define BNXT_STATS_CAP_PCIE		BIT(4)
	#define BNXT_STATS_CAP_EXT		BIT(5)
	#define BNXT_STATS_CAP_HW_EXT		BIT(6)
	#define BNXT_STATS_CAP_GENERIC		BIT(7)
	#define BNXT_STATS_CAP_LPBK		BIT(8)
	#define	BNXT_STATS_CAP_VF_EJECTION	BIT(9)
	#define BNXT_STATS_CAP_DB_ERROR		BIT(10)
	#define BNXT_STATS_CAP_PFC_WD		BIT(11)
...
#define BNXT_PTP_USE_RTC(bp)	(!BNXT_MH(bp) && \
	...
	struct bnxt_stats_mem	pfc_wd_stats;
...
#define BNXT_MAX_STATS_COAL_TICKS	 1000000
	...
	DECLARE_BITMAP(sp_event, BNXT_MAX_SP_EVENTS);
#define BNXT_MAX_TBL_SCOPE_VFS		128
	DECLARE_BITMAP(tbl_scope_vf_ids, BNXT_MAX_TBL_SCOPE_VFS);
...
#define BNXT_TF_MAX_FLTR	(BNXT_TF_NTP_FLTR_MAX_FLTR + BNXT_L2_FLTR_MAX_FLTR)
...
#define BNXT_TF_FLAG_IN_SWITCHDEV(bp) ((bp)->tf_flags & BNXT_TF_FLAG_SWITCHDEV)
...
#define BNXT_PFC_WD_STATS_OFFSET(counter)		\
	(offsetof(struct rx_port_stats_ext_pfc_wd_v2, counter) / 8)

#define BNXT_PFC_WD_STATS_SIZE				\
	(sizeof(struct rx_port_stats_ext_pfc_wd_v2))
...
#define BNXT_TF_REINIT_IS_NEEDED(bp)	(BNXT_PF(bp) &&		\
					BNXT_TRUFLOW_EN(bp) &&	\
...
void bnxt_get_rssctx_vnic_id(struct bnxt *bp, u16 *vnic_id, struct bnxt_ntuple_filter *fltr);
#endif
