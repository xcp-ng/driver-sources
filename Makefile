...
ifneq ($(shell grep -so "pcie_tph_set_st" $(LINUXSRC)/include/linux/pci-tph.h),)
...
ifeq ($(bnxt_quic),"TRUE")
  ...
  QUIC_FILES_INC = json
  QUIC_FILES_OBJ = json/kjson_main.o json/kjson_parser.o
  QUIC_ARTIFACTS = json/kjson_main.o json/kjson_parser.o json/.kjson_*
else
  QUIC_FILES_INC = json
  QUIC_FILES_OBJ =
  QUIC_ARTIFACTS =
...
clean:
	...
	-rm -rf bnxt_vfr.o .bnxt_vfr.* bnxt_nic_flow.o .bnxt_nic_flow.* bnxt_tc.o .bnxt_tc.* bnxt_devlink.o .bnxt_devlink.* $(QUIC_ARTIFACTS)

	-rm -rf bnxt_dim.o .bnxt_dim.* bnxt_debugfs*.o .bnxt_debugfs* bnxt_coredump.o .bnxt_coredump.* bnxt_auxbus_compat.o .bnxt_auxbus_compat.* bnxt_mpc.o .bnxt_mpc.* bnxt_ktls.o .bnxt_ktls.* bnxt_quic.o .bnxt_quic.* bnxt_hdbr.o .bnxt_hdbr.* bnxt_tfc.o .bnxt_tfc.* bnxt_hwmon.o .bnxt_hwmon.*  bnxt_log.o .bnxt_log.* bnxt_log_data.o .bnxt_log_data.* bnxt_xsk.o .bnxt_xsk.* $(QUIC_ARTIFACTS)
