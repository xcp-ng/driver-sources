...
void lpfc_prep_embed_io(struct lpfc_hba *phba,
...
int lpfc_auth_handle_cmd(struct lpfc_vport *vport, struct lpfc_iocbq *iocb,
			 struct lpfc_nodelist *ndlp);
#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)
...
int lpfc_els_free_iocb(struct lpfc_hba *phba, struct lpfc_iocbq *iocb);
int lpfc_ct_free_iocb(struct lpfc_hba *phba, struct lpfc_iocbq *iocb);
int lpfc_els_rsp_acc(struct lpfc_vport *vport, uint32_t flag,
		     struct lpfc_iocbq *iocb, struct lpfc_nodelist *ndlp,
		     LPFC_MBOXQ_t *mbox);
int lpfc_els_rsp_reject(struct lpfc_vport *vport, uint32_t flag,
			struct lpfc_iocbq *iocb, struct lpfc_nodelist *ndlp,
			LPFC_MBOXQ_t *mbox);
int lpfc_els_rsp_adisc_acc(struct lpfc_vport *vport, struct lpfc_iocbq *iocb,
			   struct lpfc_nodelist *ndlp);
int lpfc_els_rsp_prli_acc(struct lpfc_vport *vport, struct lpfc_iocbq *iocb,
			  struct lpfc_nodelist *ndlp);
...
struct lpfc_iocbq *lpfc_prep_els_iocb(struct lpfc_vport *vport,
				      u8 expectRsp, uint16_t cmdSize,
				      u8 retry,
				      struct lpfc_nodelist *ndlp,
				      u32 did, u32 elscmd);
void lpfc_sli_prep_wqe(struct lpfc_hba *phba, struct lpfc_iocbq *iocb);
...
int lpfc_get_gidft_type(struct lpfc_vport *vport, struct lpfc_iocbq *iocb);
...
void lpfc_sli_cancel_iocbs(struct lpfc_hba *phba, struct list_head *iocblist,
			   u32 status, u32 word);
...
int lpfc_sli_issue_iocb(struct lpfc_hba *phba, uint32_t ring,
			struct lpfc_iocbq *iocb, uint32_t flag);
...
int lpfc_sli_sum_iocb(struct lpfc_vport *vport, uint16_t tid, uint64_t luid,
		      lpfc_ctx_cmd ctxcmd);
...
struct lpfc_nodelist *lpfc_refnode_did(struct lpfc_vport *, uint32_t);
struct lpfc_nodelist *lpfc_refnode_wwpn(struct lpfc_vport *,
					struct lpfc_name *);
...
int lpfc_sli_issue_iocb_wait(struct lpfc_hba *phba, uint32_t ringno,
...
#else
int lpfc_bsg_request(struct bsg_job *job);
int lpfc_bsg_timeout(struct bsg_job *job);
#endif
...
struct lpfc_iocbq *lpfc_sli_ringtx_get(struct lpfc_hba *phba,
				       struct lpfc_sli_ring *ring);
int __lpfc_sli_issue_iocb(struct lpfc_hba *phba, uint32_t ringno,
			  struct lpfc_iocbq *iocb, uint32_t flag);
