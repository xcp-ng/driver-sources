...
enum lpfc_nlp_flag {
	...
	NLP_SKIP_EXT_DIF   = 2,         /* Target could support External DIF */
	...
	NLP_AUTH_TMO       = 14,        /* authentication timer is active */
	...
	NLP_EXTERNAL_DIF   = 29,        /* Target could support External DIF */
