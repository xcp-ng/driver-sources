...
/* TODO: Temporarily defined, and will eventually replace ulp_bde64 when all
 * mbox commands using ulp_bde64 are converted
 */
...
#define lpfc_rcqe_bindex_v1_SHIFT	16
#define lpfc_rcqe_bindex_v1_MASK	0x00007FFF
#define lpfc_rcqe_bindex_v1_WORD	word0
#define lpfc_rcqe_bindex_SHIFT		16
#define lpfc_rcqe_bindex_MASK		0x00000FFF
...
#define FC_STATUS_RQ_DMA_FAILURE	0x14 /* DMA failure */
	uint32_t word1;
#define lpfc_rcqe_enc_SHIFT		31
#define lpfc_rcqe_enc_MASK		0x00000001
#define lpfc_rcqe_enc_WORD		word1
#define lpfc_rcqe_sa_index_SHIFT	0
#define lpfc_rcqe_sa_index_MASK		0x00000FFF
#define lpfc_rcqe_sa_index_WORD		word1
...
#define lpfc_mbx_wr_object_eof_WORD     word0
			...
			uint32_t wr_object_name[LPFC_MBX_OBJECT_NAME_LEN_DW];
...
#define lpfc_mbx_cq_create_set_cqe_cnt_SHIFT	16
#define lpfc_mbx_cq_create_set_cqe_cnt_MASK	0x00007FFF
#define lpfc_mbx_cq_create_set_cqe_cnt_WORD	word2
...
enum read_config_word1 {
	RD_CFG_EXT		= 0x80,
	RD_CFG_EXT_SHIFT	= 7,

	RD_CFG_FAWWPN		= 0x40,
	RD_CFG_FAWWPN_SHIFT	= 6,
...
enum read_config_word2 {
	RD_CFG_LINK_TYPE	= 0xc0,
	RD_CFG_LINK_TYPE_SHIFT	= 6,

	RD_CFG_LINK_NUM		= 0x3f,

	RD_CFG_TRUNK		= 0xf0,
	RD_CFG_TRUNK_SHIFT	= 4,
...
struct lpfc_mbx_read_config {
	__le16 rsvd4;
	u8 rsvd6;
	u8 ext_fawwpn_fabl_wcs_acs; /* ext 7, fawwpn 6, fabl 5, wcs 4
				     * acs 3, rsvd 2:0
				     */

	u8 link_type_num; /* link_type 7:6, link_num 5:0 */
	u8 trunk_ldv; /* trunk 7:4, rsvd 3:1, ldv 0 */
	u8 ptv_tf_pt; /* ptv 7, tf 6, pt 5:4, rsvd 3:0 */
	u8 topology;
	...
	u8 bbscn_max_min; /* bbscn_max 7:4, bbscn_min 3:0 */
	u8 bbscn_def; /* rsvd 7:4, bbscn_def 3:0 */
	__le16 rsvd34;
...
struct lpfc_els_rdf_rsp {
	...
	__be32 lnk_srv_req_word2;
	__be32 lnk_srv_req_word3;
...
#else  /* defined(FC_LS_TLV_DTAG_INIT) */

/* On an older kernel, add what should be in <uapi/scsi/fc/fc_els.h> */
...
#if !defined(FC_EDC_CG_SIGNAL_CAP_TYPES_INIT)
/*
...
#endif  /* !defined(FC_EDC_CG_SIGNAL_CAP_TYPES_INIT) */
