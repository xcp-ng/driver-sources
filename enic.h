...
/* PCI sub dev id for VIC cards */
#define PCI_SUBDEV_ID_CISCO_VIC_1225	0X085  /* lexington */
#define PCI_SUBDEV_ID_CISCO_VIC_1285	0X0CD  /* icehouse2 */
#define PCI_SUBDEV_ID_CISCO_VIC_1225T	0x0CE  /* kirkwoodlake */
#define PCI_SUBDEV_ID_CISCO_VIC_1227	0x12E  /* susanville */
#define PCI_SUBDEV_ID_CISCO_VIC_1227T	0x139  /* torrance */

#define PCI_SUBDEV_ID_CISCO_VIC_1385	0x14D  /* clearlake */
#define PCI_SUBDEV_ID_CISCO_VIC_1387	0x15D  /* claremont */
#define PCI_SUBDEV_ID_CISCO_VIC_1455	0x0217 /* brentwood */
#define PCI_SUBDEV_ID_CISCO_VIC_1457	0x0218 /* bradbury */
#define PCI_SUBDEV_ID_CISCO_VIC_1467	0x02AF /* brisbane */

#define PCI_SUBDEV_ID_CISCO_VIC_1477	0x2B0 /* benton */
#define PCI_SUBDEV_ID_CISCO_VIC_1485	0x219 /* bayside */
#define PCI_SUBDEV_ID_CISCO_VIC_1487	0x21A /* burlingame */
#define PCI_SUBDEV_ID_CISCO_VIC_1495	0x24A /* bayside */
#define PCI_SUBDEV_ID_CISCO_VIC_1497	0x24B /* beaumount */

#define PCI_SUBDEV_ID_CISCO_VIC_15235	0x2E4 /* helsinki */
#define PCI_SUBDEV_ID_CISCO_VIC_15238	0x2E8 /* turku */
#define PCI_SUBDEV_ID_CISCO_VIC_15237	0x2F3 /* turku plus */

#define PCI_SUBDEV_ID_CISCO_VIC_15428	0x2DD /* stockholm */
#define PCI_SUBDEV_ID_CISCO_VIC_15427	0x2E0 /* riga */
#define PCI_SUBDEV_ID_CISCO_VIC_15425	0x2F2 /* gothenburg */

#define PCI_SUBDEV_ID_CISCO_VIC_1240	0X084 /* cotati */
#define PCI_SUBDEV_ID_CISCO_VIC_1280	0X04F /* vasona */

#define PCI_SUBDEV_ID_CISCO_VIC_1340	0X12C /* calistoga */
#define PCI_SUBDEV_ID_CISCO_VIC_1380	0X137 /* mountainview */

#define PCI_SUBDEV_ID_CISCO_VIC_1440	0x215 /* bakersfield */
#define PCI_SUBDEV_ID_CISCO_VIC_1480	0x216 /* boonville */
#define PCI_SUBDEV_ID_CISCO_VIC_14425	0x2CF /* twin River */
#define PCI_SUBDEV_ID_CISCO_VIC_14825	0x2D0 /* twin Peak */
#define PCI_SUBDEV_ID_CISCO_VIC_15230	0x2DF /* zurich */
#define PCI_SUBDEV_ID_CISCO_VIC_15231	0x2DB /* lucerne */
#define PCI_SUBDEV_ID_CISCO_VIC_15411	0x2DC /* krakow */
#define PCI_SUBDEV_ID_CISCO_VIC_15412	0x2E2 /* warsaw */
#define PCI_SUBDEV_ID_CISCO_VIC_15420	0x2DE /* bern */
#define PCI_SUBDEV_ID_CISCO_VIC_15422	0x2E1 /* geneva */
...
#define ENIC_SRIOV_ENABLED_USNIC	(1 << 1)
#define ENIC_SRIOV_ENABLED_V2		(1 << 2)
#define ENIC_SW_RX_STATS		(1 << 3)
...
struct enic {
	...
	unsigned int wq_count[ENIC_MAX_QP_TYPE];
	...
	unsigned int rq_count[ENIC_MAX_QP_TYPE];
	u32 __iomem *legacy_pba;		/* memory-mapped */

	unsigned int cq_count[ENIC_MAX_QP_TYPE];
	...
	unsigned int err_notify_open_count;
	unsigned int enable_count;
	atomic_t remove_in_progress;

	/* If not zero, use this device ID instead of the real one in
	 * pdev when checking vnic type. Currently, it's used to make
	 * VF to act as a regular vnic, to make this driver compatible
	 * with ESX PF driver. See enic_sriov_check_capability.
	 */
	u16 override_dev_id;
};
...
static inline u16 enic_dev_id(struct enic *enic)
{
	return enic->override_dev_id ? enic->override_dev_id : enic->pdev->device;
}
