...
%define kernel_type %(uname -r | rev | cut -d. -f 2 | rev | cut -c4-6)
%define _rpmfilename %%{ARCH}/%%{NAME}-%%{VERSION}-%%{RELEASE}%kernel_type.%%{ARCH}.rpm
...
%changelog
* Wed Apr 15 2020 Gian Carlo Boffa <gcboffa@cisco.com>
- spec file for Oracle Enterprise Linux build 
