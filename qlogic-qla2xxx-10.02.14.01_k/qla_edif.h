...
enum auth_msg_code {
	...
	AUTH_Negotiate = 0xb,
	AUTH_Done = 0xc,
	DHCHAP_Challenge = 0x10,
	DHCHAP_Reply = 0x11,
	DHCHAP_Success = 0x12,
	FCAP_Request = 0x13,
	FCAP_Acknowledge = 0x14,
	FCAP_Confirm = 0x15,
	FCPAP_Init = 0x16,
	FCPAP_Accept = 0x17,
	FCPAP_Complete = 0x18,
	IKE_SA_Init = 0x22,
	IKE_Auth = 0x23,
	IKE_Create_Child_SA = 0x24,
	IKE_Informational = 0x25,
	FCEAP_Request = 0x26,
	FCEAP_Response = 0x27,
	FCEAP_Success = 0x28,
	FCEAP_Failure = 0x29,
...
#define EDIF_SESSION_DOWN(_s) \
	(_s->disc_state == DSC_DELETE_PEND || _s->disc_state == DSC_DELETED || \
