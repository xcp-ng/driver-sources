...
#ifdef BCM_HAS_NEW_VPD_SCHEME
#ifndef PCI_VPD_LRDT
#define PCI_VPD_LRDT			0x80	/* Large Resource Data Type */
#define PCI_VPD_LRDT_ID(x)		(x | PCI_VPD_LRDT)
#endif

#ifndef PCI_VPD_STIN_END
...
#ifndef BCM_HAS_VPD_FIND_INFO_KEYWORD
/**
...
#if !defined(BCM_HAS_OLD_VPD_FIND_TAG_WO_OFF) && !defined(BCM_HAS_OLD_VPD_FIND_TAG)
...
#endif /* BCM_HAS_VPD_FIND_INFO_KEYWORD */
#endif
 ...
 */
#undef netdev_printk
#undef BCM_HAS_NETDEV_INFO
#undef BCM_HAS_NETDEV_ERR
#undef BCM_HAS_NETDEV_WARN
#endif
...
#ifndef BCM_HAS_NETDEV_ERR
#define netdev_err(dev, format, args...)			\
	netdev_printk(KERN_ERR, dev, format, ##args)
#endif

#ifndef BCM_HAS_NETDEV_WARN
#define netdev_warn(dev, format, args...)			\
	netdev_printk(KERN_WARNING, dev, format, ##args)
#endif

#ifndef BCM_HAS_NETDEV_NOTICE
#define netdev_notice(dev, format, args...)			\
	netdev_printk(KERN_NOTICE, dev, format, ##args)
#endif

#ifndef BCM_HAS_NETDEV_INFO
...
#ifndef BCM_HAS_NEW_TX_TIMEOUT
#define tg3_tx_timeout(dev, txqueue) tg3_tx_timeout(dev)
#endif
...
#define TG3_NAPI
#ifdef BCM_HAS_NAPI_COMPLETE_DONE
#define napi_complete_(dev, napi, workdone)	napi_complete_done((napi), (workdone))
#else
#define napi_complete_(dev, napi, workdone)     napi_complete((napi))
#endif
#define napi_complete_recovery(dev, napi)	napi_complete((napi))
...
#define TG3_NAPI
#define napi_complete_(dev, napi, workdone)	netif_rx_complete((dev), (napi))
#define napi_complete_recovery(dev, napi)	netif_rx_complete((dev), (napi))
...
#define napi_complete_(dev, napi, workdone)	netif_rx_complete((dev))
#define napi_complete_recovery(dev, napi)	netif_rx_complete((dev))
...
{
#if defined BCM_HAS_PCI_CHANNEL_IO_NORMAL_ENUM && !defined (__VMKLNX__)
...
#ifdef BCM_HAS_SKB_CHECKSUM_HELP_OLD
#define skb_checksum_help(skb) skb_checksum_help(skb, 0)
#endif

#ifndef BCM_HAS_NETDEV_RSS_KEY_FILL
void netdev_rss_key_fill(void *buffer, size_t len)
{
	u32 *rss_hash = buffer;
	/* Setup the "secret" hash key. */
	rss_hash[0] = 0x5f865437;
	rss_hash[1] = 0xe4ac62cc;
	rss_hash[2] = 0x50103a45;
	rss_hash[3] = 0x36621985;
	rss_hash[4] = 0xbf14c0e8;
	rss_hash[5] = 0x1bc27a1e;
	rss_hash[6] = 0x84f4b556;
	rss_hash[7] = 0x094ea6fe;
	rss_hash[8] = 0x7dda01e7;
	rss_hash[9] = 0xc04d7481;
}
#endif

#ifdef BCM_HAS_NEW_VPD_SCHEME
#ifdef BCM_HAS_OLD_VPD_FIND_TAG_WO_OFF
#define pci_vpd_find_tag(buf, off, len, rdt) pci_vpd_find_tag(buf, len, rdt)
#endif
#endif

#ifndef BCM_HAS_FALLTHROUGH
...
#ifndef BCM_HAS_CQE_ETHTOOL_COALESCE
#define tg3_get_coalesce(dev, coal, kernel_coal, extack)	\
	tg3_get_coalesce(dev, coal)

#define tg3_set_coalesce(dev, coal, kernel_coal, extack)	\
	tg3_set_coalesce(dev, coal)
...
#define tg3_set_ringparam(dev, ering, kernel_ering, extack)	\
	tg3_set_ringparam(dev, ering)
#endif /* BCM_HAS_RINGPARAMS */
