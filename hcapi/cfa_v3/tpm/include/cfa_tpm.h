...
/** CFA Table Scope Pool Manager get fid count API
 *
 * This API returns how many fids are currently associated the pool instance
 *
 * @param[in] tpm
 *   Pointer to the database memory for the Table Scope Pool Manager.
 *
 * @param[in/out] fid_cnt
 *   Pointer to memory location to return the number of fids.
 *
 * @return
 *   Returns 0 if successful, Error Code otherwise
 */
