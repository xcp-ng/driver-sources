...
#ifndef MPI3_SB_MANIFEST_CI_DIGEST_NUM
 #define MPI3_SB_MANIFEST_CI_DIGEST_NUM                                (1)
#endif
struct mpi3_sb_manifest_ci_ref_element {
	u8                              num_ci_digests;
	u8                              reserved01[3];
	struct mpi3_sb_manifest_ci_digest   ci_digest[MPI3_SB_MANIFEST_CI_DIGEST_NUM];
};
#ifndef MPI3_SB_MANIFEST_EMBED_KEY_SIZE
 #define MPI3_SB_MANIFEST_EMBED_KEY_SIZE                               (1)
#endif
struct mpi3_sb_manifest_embedded_key_element {
	...
	__le32                      start_tag;
	__le32                      public_key[MPI3_SB_MANIFEST_EMBED_KEY_SIZE];
};
...
#ifndef MPI3_SB_MANIFEST_DIAG_KEY_SIZE
 #define MPI3_SB_MANIFEST_DIAG_KEY_SIZE                                   (1)
#endif
struct mpi3_sb_manifest_diag_key_element {
	...
	u8                          flags;
	__le16                      public_key_size;
	__le32                      public_key[MPI3_SB_MANIFEST_DIAG_KEY_SIZE];
};
...
struct mpi3_sb_manifest_element {
	...
	u8                                   reserved01[3];
	union mpi3_sb_manifest_element_data     form_specific[1];
};
...
struct mpi3_sb_manifest_mpi {
	...
	__le32                                   diag_authorization_key_offset;
	__le32                                   reserved5c[9];
	struct mpi3_sb_manifest_element              manifest_elements[1];
};
