 ...
 * ----------------------------------------------------------------------
 * | Module Init and Probe        |       0x01aa       |                |
 * | Mailbox commands             |       0x1205       | 0x11a8-0x11ff	|
...
#ifdef TRACE_EVENTS_QLA_H
#include <trace/events/qla.h>
#else
#include "qla.h"
#endif // TRACE_EVENTS_QLA_H
...
void
ql_scm_dump_buffer(uint level, scsi_qla_host_t *vha, uint id, void *buf,
	uint size)
{
	uint cnt;
