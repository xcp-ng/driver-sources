/*
 *  QLogic FCoE/iSCSI Offload Driver
 *  Copyright (c) 2015-2018 Cavium Inc.
 *
 *  See LICENSE.qedf/qedi for copyright and licensing details.
 */
...
#define QEDI_UEVENT_CODE_GRCDUMP 0
...
int qedi_alloc_grc_dump_buf(uint8_t **, uint32_t);
void qedi_free_grc_dump_buf(uint8_t **);
int qedi_get_grc_dump(struct qed_dev *, const struct qed_common_ops *,
		      uint8_t **, uint32_t *);
void qedi_uevent_emit(struct Scsi_Host *, u32, char *);
