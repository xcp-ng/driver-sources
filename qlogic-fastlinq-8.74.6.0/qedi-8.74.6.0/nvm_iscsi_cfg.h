...
#define NVM_ISCSI_CFG_GEN_IPV6_ENABLED                 BIT(3) // deprecated, please use NVM_ISCSI_CFG_INITIATOR_IP_VERSION setting for initiator
#define NVM_ISCSI_CFG_GEN_IPV4_FALLBACK_ENABLED        BIT(4) // deprecated, please use NVM_ISCSI_CFG_INITIATOR_IP_VERSION_PRIORITY_V6
