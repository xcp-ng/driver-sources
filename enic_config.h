...
/* Does netdevice.h define netdev_hw_addr? */
#define ENIC_HAVE_NDO_SET_MAC_ADDRESS 1
...
/* Does netdevice.h define netdev_xxx_once() logging fns? */
...
#define PACKAGE_STRING "enic 4.4.0.1-930.6"
...
#define PACKAGE_VERSION "4.4.0.1-930.6"
