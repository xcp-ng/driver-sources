...
#define BNX2I_FW_MAX_BDS_PER_CMD	255
...
#endif
extern unsigned int bnx2i_ssan_feature;
...
#define BNX2I_DBG_LOG(hba, fmt, arg...)					       \
	if (debug_logging)						       \
		pr_info("bnx2i(%s): " fmt, hba->netdev->name, ##arg);	       \

#define BNX2I_DBG_CONN(conn, fmt, arg...)				       \
	if (debug_logging)						       \
		iscsi_conn_printk(KERN_ALERT, conn, fmt, ##arg);	       \
