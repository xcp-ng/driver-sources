...
#ifdef _DEFINE_VOID_DEBUGFS_CREATE_U32_
#define BNX2I_LOGIN_STATS_ATTR_U32(_name, _mode, _parent) \
		debugfs_create_u32(#_name, _mode, _parent, &hba->login_stats._name);
#else
#define BNX2I_LOGIN_STATS_ATTR_U32(_name, _mode, _parent) \
...
#if defined(RHEL8_DEBUGFS) || defined(RHEL9_DEBUGFS) || \
    defined(UBUNTU_DEBUGFS) || defined(SLES15_DEBUGFS)
...
{
#ifndef _DEFINE_VOID_DEBUGFS_CREATE_U32_
	struct dentry *attr;
#endif
