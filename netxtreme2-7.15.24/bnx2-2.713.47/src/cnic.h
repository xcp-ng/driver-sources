...
#define CNIC_MAX_JUMBO_PACKET_SIZE	0x2400
...
#define BNX2X_RX_DESC_CNT		(CNIC_PG_SZ_L2 / sizeof(struct eth_rx_bd))
#define BNX2X_MAX_RX_DESC_CNT		(BNX2X_RX_DESC_CNT - 2)
#define BNX2X_RCQ_DESC_CNT		(CNIC_PG_SZ_L2 / sizeof(union eth_rx_cqe))
