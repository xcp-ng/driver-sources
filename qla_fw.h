...
struct nvram_81xx {
	...
	__le16 reserved_6_3[8];

	/*
	 * BIT 0  = scmr from app
	 * BIT 1  = scmr default queue
	 * BIT 2  = scmr driver throttling
	 * BIT 3-7= Reserved
	 */
	uint8_t	scmr_control_flags;

	/* Monitor - 0, Conservative - 1, Moderate - 2, Aggressive - 3*/
	uint8_t scmr_throttle_profile;

	uint8_t reserved_6_4[10];

	/* Offset 192. */
	uint8_t min_supported_speed;
	/*
	 * BIT 0  = port disabled state
	 * BIT 1  = fabric priority enabled
	 * BIT 2  = Use Virtual Lanes
	 * BIT 3-7= Reserved
	 */
	uint8_t port_features;
...
#define FWO3_DATA_RATE_MASK 0x0000E000
#define FWO3_DATA_RATE_SHIFT 13
