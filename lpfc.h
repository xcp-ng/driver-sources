...
#define LPFC_INQ_STANDARD_LEN	36
...
#define LPFC_CFG_SEVERE		2
	uint8_t  cgn_param_level1;	/* Burst in 512K units */
#define LPFC_CFG_BURST_MIN	0
#define LPFC_CFG_BURST_MAX	32
#define LPFC_CFG_BURST_DEF	4
	uint8_t  cgn_param_level2;	/* BW in units of 5% */
...
#define LPFC_CGN_INFO_V4	4
	...
	uint8_t  cgn_info_level0;	/* 0=conserve 1=moderate 2=aggressive */
	uint8_t  cgn_info_level1;	/* Burst in 512K units */
	uint8_t  cgn_info_level2;	/* BW in units of 5% */
...
#if (IS_ENABLED(CONFIG_NVME_FC)) && defined(BUILD_NVME)
