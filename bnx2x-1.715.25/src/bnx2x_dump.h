...
#define REGDUMP_HEADER_SIZE_BYTES		sizeof(u32)
#define REGDUMP_HEADER_SIZE_DWORDS		\
	BYTES_TO_DWORDS(REGDUMP_HEADER_SIZE_BYTES)
#define REGDUMP_HEADER_SIZE			0x00ffffff
#define REGDUMP_HEADER_SIZE_SHIFT		0
#define REGDUMP_HEADER_FEATURE_SHIFT		24
#define REGDUMP_HEADER_FEATURE			0x1f000000
#define REGDUMP_HEADER_BIN_DUMP_SHIFT		29
#define REGDUMP_HEADER_BIN_DUMP			0x20000000

/* Do not change these value without making sure the
 * parsing tool (ethtool-d.c) has same values as well
 */
...
static u32 bnx2x_calc_regdump_header(struct bnx2x *bp,
				enum debug_print_features feature,
				u32 feature_size, u8 dbg_bin_dump)
{
	u32 res = 0;

	SET_FLAG(res, REGDUMP_HEADER_SIZE, feature_size);
	SET_FLAG(res, REGDUMP_HEADER_FEATURE, feature);
	SET_FLAG(res, REGDUMP_HEADER_BIN_DUMP, dbg_bin_dump);
