...
#define VF_LOST		4	/* Recovery while VFs are loaded */
	...
	bool spoofchk;		/* true if spook check is enabled */
...
#define bnx2x_leading_vfq(vf, var)	((vf)->vfqs[LEADING_IDX].var)
	...
	/* if 'use_random_vf_mac' module parameter is set, this mac
	 * would be used by default for the VF.
	 */
...
#endif
static inline int bnx2x_vfpf_config_mac(struct bnx2x *bp, u8 const *addr,
...
static inline int bnx2x_set_vf_spoofchk(struct net_device *dev, int idx,
					bool val)
{
	return 0;
}
