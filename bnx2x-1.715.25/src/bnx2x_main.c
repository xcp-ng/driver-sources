...
#include "bnx2x.h"
#ifdef _HAS_NDO_FEATURES_VXLAN_CHECK
#include <net/vxlan.h>
#endif
...
#ifdef _HAS_NEW_DEFINE_SEMAPHORE
...
static void __devinit bnx2x_read_fwinfo(struct bnx2x *bp)
{
	 ...
	 */
#if (defined(_HAS_PCI_VPD_FIND_TAG_OFFSET) || (defined(PCI_VPD_INLINE)))
...
#else
    /* if be Default PCI AER is enabled */
	bp->flags |= AER_ENABLED;
#endif
#else
